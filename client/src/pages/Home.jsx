  ...
  return (
    <div className="home--page" id="home">
      ...
      <div className="hero--section" id="hero">
        <h1 data-aos="fade-up">BIG SOLUTIONS FOR SMALL BUSINESS.</h1>
        <button className="btn" data-aos="fade-up">
          <a href="#contact">CLICK TO GROW YOUR BUSINESS</a>
        </button>
        <a href="#about">
      ...
      <div className="about-us--section" id="about">
        <div className="about-us-text--container" data-aos="fade-in">
          <h2>ABOUT US</h2>
          <article>
            Welcome to loskutech, a full-service digital agency specializing in
            website design and development, online marketing, and branding.{" "}
            <br />
            Our team is made up of talented designers, developers, and marketers
            who are passionate about helping businesses succeed online. We have
            a diverse range of skills and expertise, and we bring this to bear
            on every project we work on. <br />
            Our process is collaborative and transparent, and we work closely
            with our clients to understand their goals and help them achieve
            them. We believe that the key to creating successful websites and
            online campaigns is to combine creative thinking with technical
            expertise and a deep understanding of our clients' industries and
            target audiences. <br />
            We take pride in our work and strive to exceed our clients'
            expectations on every project. If you're looking for a partner to
            help you grow your business online, we'd love to hear from you.
            Contact us today to learn more about how we can help you succeed.
          </article>
        </div>
        <div className="hello-text" data-aos="fade-in">
          <h2>
            HI, WE ARE <br /> LOSKUTECH
          </h2>
        </div>
      </div>
          ...
          {modalOpen ? (
            ...
            >
              ...
              <div className="modal-header">
                <img
                  src={modalData.icon}
                  alt={`big card icon ${modalData.name}`}
                />
      ...
      <div className="our-work--section" id="our-work">
        ...
        <div className="our-work--container" data-aos="fade-down">
          ...
          >
            ...
            <div className="card-body"></div>
            <div className="card-footer">
              <h3>CRYSTAL GLASS AND GLAZING</h3>
              <h4>WEB DESIGN</h4>
            </div>
          </Tilt>
        </div>
      </div>
      {/* <div className="our-team--section" data-aos="fade-in">
        <h2>OUR TEAM</h2>
          ...
          {team.map((person, index) => (
            <div className="person-card">
              ...
              <div className="person-card--body">
                <article>{person.about}</article>
              </div>
              <div className="person-card--footer"></div>
            </div>
          ))}
        </div>
      </div> */}
      <div className="contact--section" data-aos="fade-in" id="contact">
        ...
        <div className="form--container" data-aos="fade-in">
          <Form />
          <div>
            {/* {localStorage.getItem("prize") === "nothing" ? (
              " "
            ) : (
              <h4>YOUR CODE: {localStorage.getItem("prize")}</h4>
            )} */}
          </div>
        </div>
      </div>
